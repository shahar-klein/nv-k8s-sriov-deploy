...
echo "Create the DB Backend and Web Frontend"
...
echo "Initialize the DB using NodePort"
...
echo "Insert sample data into the DB using NodePort"
...
echo "Retrieve the data from Node3 using NodePort"
...
echo "Insert sample data into the DB using ClusterIP"
...
echo "Retrieve the data using ClusterIP"
